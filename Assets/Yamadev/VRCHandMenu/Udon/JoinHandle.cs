    ...
    public class JoinHandle : UdonSharpBehaviour
    {
        ...
        public void UpdateView()
        {
            ...
            for (var i = start; i < joinLogs.Length; i++)
            {
                ...
                var hourStr = hourSpan != 0 ? $"{hourSpan}{mainSystem.sHour}" : "";
                var minuteStr = $"{minuteSpan}{mainSystem.sMinute}";
                ...
                if (extraText) extraText.text = $"({hourStr}{minuteStr}{mainSystem.sBefore})";
